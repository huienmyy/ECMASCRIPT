...
<li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="./resources/category/add-cate.html">Thêm mới</a>
            <a class="collapse-item" href="./resources/category/list-cate.html">Danh sách</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseOrder" class="collapse" aria-labelledby="headingOrder" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="./resources/order/list-or.html">Danh sách đơn hàng</a>
        </div>
    </div>
</li>
